        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
	<form id="add_group" method="post" action="<?php echo base_url('services/editpost');?>" enctype="multipart/form-data">
							...
							<tr id='addr0'>
								<td>
									 <div class="form-group">
									  ...
									  <input type="text"  name="services_name" class="form-control" value="<?php echo isset($services_details['services_name'])?$services_details['services_name']:'' ?>"  placeholder="Enter Services Name" >
									</div>
                                    </div>
									</td>
