        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
	<form id="add_group" method="post" action="<?php echo base_url('gallery/editpost');?>" enctype="multipart/form-data">
      <input type="hidden" id="g_id" name="g_id" value="<?php echo isset($gallery_details['g_id'])?$gallery_details['g_id']:''; ?>">
